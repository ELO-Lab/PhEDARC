...
from core.darc import GeneticAgent
...
parser.add_argument('--env', help='Environment Choices: (HalfCheetah-v2) (Ant-v2) (Walker2d-v2) (Hopper-v2)', 
...
def evaluate(agent, env, trials=1, render=False):
    for trial in range(trials):
        ...
        while not done:
            ...
            action = agent.actor.select_action(env,np.array(state),1,0)
